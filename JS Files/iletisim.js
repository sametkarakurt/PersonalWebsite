...
function dogruMu() {
    ...
    if (isim == null || isim == "" || soyisim == null || soyisim == "" || email == null || email == "" || mesaj == null || mesaj == "" || konu == "Konu" || onayButonu.checked == false )
    {
        uyarıText.innerHTML = "Bir veya daha fazla alanda hata bulundu. Lütfen kontrol edin ve tekrar deneyin."
